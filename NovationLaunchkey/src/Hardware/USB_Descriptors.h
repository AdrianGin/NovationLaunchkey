...
#define CONFIG_DESCRIPTOR_LENGTH	(9)
...
#define MS_MIDI_CS_BULK_OUT_LEN	(4+AUDIO_MIDI_IN_PORT_COUNT)

#define MS_MIDI_BULK_IN_LEN		(9)
#define MS_MIDI_CS_BULK_IN_LEN	(4+AUDIO_MIDI_OUT_PORT_COUNT)

#define MS_CLASS_LENGTH	(MIDI_STREAMING_CLASS_LEN + \
						 AUDIO_MIDI_IN_PORT_COUNT  * MS_MIDI_IN_DESC_LEN	* (MS_EMBEDDED_IN_PORT_COUNT+MS_EXTERNAL_IN_PORT_COUNT) + \
						 AUDIO_MIDI_OUT_PORT_COUNT * MS_MIDI_OUT_DESC_LEN	* (MS_EMBEDDED_OUT_PORT_COUNT+MS_EXTERNAL_OUT_PORT_COUNT) + \
